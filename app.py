...
# blog_post = run_query("INSERT INTO blog_post (username, content, id) VALUES (?,?,?)", ['3User', '3Tweet', '3'])


# blog_post = run_query("SELECT content FROM blog_post WHERE id = 1")
# This just tells me how many users there are, and 
...
user_choice = input('Choose from 1 or 2: ')
if user_choice in ('1','2'):
  if user_choice == '1':
    ...
    see_posts = run_query("SELECT username, content, id from blog_post WHERE id=2")
  else:
    print ('error')
